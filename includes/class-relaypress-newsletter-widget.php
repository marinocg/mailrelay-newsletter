 ...
 * Newsletter widget.
 */
class RelayPress_Newsletter_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'relaypress_newsletter_widget',
			__( 'RelayPress', 'relaypress-newsletter' ),
			array( 'description' => __( 'Newsletter form with Turnstile + Mailrelay API + double opt-in (neutral message) and logs.', 'relaypress-newsletter' ) )
		);
	}
	...
	public function form( $instance ) {
		...
		<?php if ( empty( $forms ) ) : ?>
			<p>
				<?php esc_html_e( 'No forms yet.', 'relaypress-newsletter' ); ?>
				<a href="
				<?php
				echo esc_url(
					add_query_arg(
				...
				?>
					...
					<?php esc_html_e( 'Create your first form', 'relaypress-newsletter' ); ?>
				</a>
			</p>
			<?php
			return;
		...
		?>
		<p><label><?php echo esc_html__( 'Form', 'relaypress-newsletter' ); ?><br>
		...
		<p><label><?php echo esc_html__( 'Title', 'relaypress-newsletter' ); ?>
				<input class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
			</label></p>
		<p><label><?php echo esc_html__( 'Description', 'relaypress-newsletter' ); ?>
				<input class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'description' ) ); ?>" type="text" value="<?php echo esc_attr( $description ); ?>">
			</label></p>
		<p><label><?php echo esc_html__( 'Email placeholder', 'relaypress-newsletter' ); ?>
		...
		<p><label><?php echo esc_html__( 'Button text', 'relaypress-newsletter' ); ?>
		...
		<p><label><?php echo esc_html__( 'Extra CSS class (optional)', 'relaypress-newsletter' ); ?>
