...
final class RelayPress_Logs {
	...
	public static function maybe_create_or_update_table(): void {
		...
		$sql = "CREATE TABLE {$table} (
            ...
            page_url TEXT NULL,
            consent_label TEXT NULL,
            consent_context VARCHAR(40) NULL,
	...
	public static function store_consent_log_compatible( array $row ): void {
		...
		$data = array(
			...
			'consent_label'             => isset( $row['consent_label'] ) ? (string) $row['consent_label'] : null,
			'consent_context'           => isset( $row['consent_context'] ) ? (string) $row['consent_context'] : null,
